...
class NetWorthFragment(private val currency: Currency) : Fragment() {
    ...
    private fun bindNetWorthRUB(netWorth: Double, change: Double, percentChange: Double) {
        binding.apply {
            flagImageView.setImageDrawable(ResourcesCompat.getDrawable(resources, R.drawable.russia, null))
    ...
    private fun bindNetWorthUSD(netWorth: Double, change: Double, percentChange: Double) {
        binding.apply {
            flagImageView.setImageDrawable(ResourcesCompat.getDrawable(resources, R.drawable.usa, null))
    ...
    private fun bindNetWorthEUR(netWorth: Double, change: Double, percentChange: Double) {
        binding.apply {
            flagImageView.setImageDrawable(ResourcesCompat.getDrawable(resources, R.drawable.eu, null))
    ...
    private fun bindNetWorthKZT(netWorth: Double, change: Double, percentChange: Double) {
        binding.apply {
            flagImageView.setImageDrawable(ResourcesCompat.getDrawable(resources, R.drawable.kazakhstan, null))
